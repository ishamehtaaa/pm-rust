...
const DEFAULT_MAKER_PRICE_OFFSET: Decimal = dec!(0.005);  /* Reduced from 1¢ to 0.5¢ for faster fills */
const DEFAULT_MAX_PRICE_AGE_MS: i64 = 1_500;  /* Reduced from 2.5s - reject stale prices faster */
const DEFAULT_COOLDOWN_SECS: u64 = 1;  /* Reduced from 2s for faster execution */
