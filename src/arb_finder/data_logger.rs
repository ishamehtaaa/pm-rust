...
impl LogEvent {
    ...
    pub fn arb_executed(
        market_id: &str,
        up_price: rust_decimal::Decimal,
        down_price: rust_decimal::Decimal,
        size: rust_decimal::Decimal,
        _profit_per_share: rust_decimal::Decimal,
    ) -> Self {
        LogEvent::Trade {
            timestamp_ms: Self::timestamp_ms(),
            market_id: market_id.to_string(),
            token_id: "arb_pair".to_string(),
            side: "arb_execute".to_string(),
            price: (up_price + down_price).to_string(),
            size: size.to_string(),
        }
    }
